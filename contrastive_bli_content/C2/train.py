...
def parse_args():
    ...
    parser.add_argument('--agg_mode', default="cls", type=str, help="{cls|mean_pool|pooler}") 
...
def main(args):
    ...
    if args.model_dir == "bert-base-multilingual-uncased" or args.model_dir == "sentence-transformers/LaBSE":
    ...
    print(f"[INFO] Dataset size: {len(train_set)} =====")
