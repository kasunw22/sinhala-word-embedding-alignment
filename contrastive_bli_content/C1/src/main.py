...
def SAVE_DATA(model, args, train_data_l1, train_data_l2, l1_idx_sup, l2_idx_sup, voc_l1, voc_l2):
    ...
    s_l = f"{args.base}/{s_l}"
    os.makedirs(os.path.join(args.save_dir, s_l), exist_ok=True)

    np.save(os.path.join(args.save_dir, "{}/{}2{}_{}_voc.npy".format(s_l, args.l1, args.l2, args.l1)), voc_l1)
    np.save(os.path.join(args.save_dir, "{}/{}2{}_{}_voc.npy".format(s_l, args.l1, args.l2, args.l2)), voc_l2)
    torch.save(train_data_l1_translation, os.path.join(args.save_dir, "{}/{}2{}_{}_emb.pt".format(s_l, args.l1, args.l2, args.l1))) #aligned l1 WEs
    torch.save(train_data_l2_translation, os.path.join(args.save_dir, "{}/{}2{}_{}_emb.pt".format(s_l, args.l1, args.l2, args.l2))) #aligned l2 WEs
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dico_max_rank", type=int, default=20000,
                    help="Number of hard negative samples in contrastive training objective")
    parser.add_argument("--max_load", type=int, default=200000,
                    help="Maximum number of embedding vectors to be loaded for the alignment")
    ...
    parser.add_argument("--save_dir", type=str, default="./",
                    help="save_dir")
    parser.add_argument("--base", type=str, default="wiki",
                    help="wiki or cc")
    ...
    args.str2lang = {"hr":"croatian", "en":"english","fi":"finnish","fr":"french","de":"german","it":"italian","ru":"russian","tr":"turkish", "es": "spanish", "si": "sinhala", "ta": "tamil", "ja": "japanese", "zh": "chinese"}
...
####LOAD WORD EMBS
    voc_l1, embs_l1 = load_embs(DIR_EMB_SRC,topk=args.max_load)
    ...
    voc_l2, embs_l2 = load_embs(DIR_EMB_TRG,topk=args.max_load)
