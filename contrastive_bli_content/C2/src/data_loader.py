...
class C2_Dataset(Dataset):
    def __init__(self, path, l1, l2, l1_voc, l2_voc, tokenizer, random_erase=0, template = 0): 
        ...
        self.str2lang = {"hr":"croatian", "en":"english","fi":"finnish","fr":"french","de":"german","it":"italian","ru":"russian","tr":"turkish", "si": "sinhala", "es": "spanish", "ta": "tamil", "ja": "japanese", "zh": "chinese"}
        self.l1 = l1
        self.l2 = l2
